...
members.Add("UseUserSpaceForDistance", UseUserSpaceForDistance_Element.ToLinkField(context));
members.Add("TouchDistance", TouchDistance_Element.ToLinkField(context));
