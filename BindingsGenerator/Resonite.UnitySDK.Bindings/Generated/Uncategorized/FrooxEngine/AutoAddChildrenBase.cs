...
members.Add("AutoAddChildren", AutoAddChildren_Element.ToLinkField(context));
members.Add("AutoAddIgnoreTags", AutoAddIgnoreTags.ToLinkList(context, m => m.ToLinkField(context)));
}
