...
members.Add("LUT", LUT_Element.ToLinkReference(context));
members.Add("SecondaryLUT", SecondaryLUT_Element.ToLinkReference(context));
members.Add("UseSRGB", UseSRGB_Element.ToLinkField(context));
