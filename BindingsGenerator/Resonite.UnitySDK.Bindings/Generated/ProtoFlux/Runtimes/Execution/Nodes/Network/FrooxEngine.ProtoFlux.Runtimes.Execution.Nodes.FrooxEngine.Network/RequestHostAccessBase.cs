...
public Reference<global::FrooxEngine.SyncRef<global::FrooxEngine.ProtoFlux.INodeOperation>, global::FrooxEngine.ProtoFlux.INodeOperation> OnGranted_Element = new();
...
public Reference<global::FrooxEngine.SyncRef<global::FrooxEngine.ProtoFlux.INodeOperation>, global::FrooxEngine.ProtoFlux.INodeOperation> OnIgnored_Element = new();

public override void CollectMembers(
    System.Collections.Generic.Dictionary<string, ResoniteLink.Member> members, IConversionContext context)
{
    base.CollectMembers(members, context);
members.Add("OnGranted", OnGranted_Element.ToLinkReference(context));
members.Add("OnDenied", OnDenied_Element.ToLinkReference(context));
members.Add("OnIgnored", OnIgnored_Element.ToLinkReference(context));
}
