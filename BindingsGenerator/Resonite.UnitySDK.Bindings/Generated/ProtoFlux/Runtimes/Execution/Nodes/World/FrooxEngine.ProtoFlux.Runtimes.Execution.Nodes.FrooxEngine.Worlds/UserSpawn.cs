...
public Reference<global::FrooxEngine.SyncRef<global::FrooxEngine.ProtoFlux.ISyncNodeOperation>, global::FrooxEngine.ProtoFlux.ISyncNodeOperation> OnSpawn_Element = new();
...
members.Add("OnSpawn", OnSpawn_Element.ToLinkReference(context));
members.Add("SpawnedUser", SpawnedUser.ToLinkEmpty(context));
}
