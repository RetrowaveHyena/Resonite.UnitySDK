...
public global::FrooxEngine.ProtoFlux.NodeValueOutput<UnityEngine.Vector3> GlobalPosition = new();
public global::FrooxEngine.ProtoFlux.NodeValueOutput<UnityEngine.Quaternion> GlobalRotation = new();
public global::FrooxEngine.ProtoFlux.NodeValueOutput<UnityEngine.Vector3> GlobalScale = new();
...
members.Add("GlobalPosition", GlobalPosition.ToLinkEmpty(context));
members.Add("GlobalRotation", GlobalRotation.ToLinkEmpty(context));
members.Add("GlobalScale", GlobalScale.ToLinkEmpty(context));
}
